# Directions 1: Import os and csv
import pandas as pd
import os
import csv

# 2: path for the CSV file in PyBank ???????????
data_output = os.path.join("Data", "budget_data.csv")

#os.path.join("PyBank", "budget_data.csv") 
...
with open(data_output) as csvfile:
